...
Voor XPLORE TÜRKIYE staat de Marmara-regio voor context en contrast. Een regio die inzicht geeft in de vorming van Turkije en tegelijk uitnodigt om verder te reizen en te verdiepen.`,
    insight: {
      title: "Sleutel tot wereldhandel",
      content:
...
Cultureel wordt Centraal-Anatolië gekenmerkt door soberheid, traditie en een sterke band met het land. Het leven volgt hier het ritme van de seizoenen en de gemeenschap. Verhalen, muziek en ambachten blijven belangrijke dragers van identiteit, vaak eenvoudiger van vorm maar rijk aan betekenis.`,
    ...
    images: ["/regios/central-anatolie.jpg"],
  },
  {
    id: "zwarte-zee",
...
Voor XPLORE TÜRKIYE staat Oost-Anatolië voor rauwe schoonheid en authenticiteit. Een regio die niet verleidt door comfort, maar door karakter, ruimte en oprechtheid.`,
    ...
    images: ["/regios/eastern-anatolia.jpg"],
  },
  {
