...
import { getRegionSchemaScript } from "@/lib/seo/regionSchema";
...
export async function generateMetadata({
  ...
  return generateSEOMetadata({
    ...
    path: `/regios/${region}`,
    image: regionData.images?.[0] || "/og-default.jpg",
  });
}
...
export default async function RegionPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <Script
        id={`region-schema-${regionData.id}`}
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: getRegionSchemaScript(
            regionData,
            `/regios/${region}`,
        ...
        <section className="relative min-h-[32vh] sm:min-h-[28vh] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            {regionData.images?.[0] && (
              <>
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary-dark/90 via-primary-dark/70 to-primary-dark/60" />
              </>
            )}
          </div>
          ...
          <div className="relative z-10 w-full">
            <div className="container mx-auto px-4 py-6 sm:py-8 text-center">
              ...
              {/* Turkey Map - PNG style without card */}
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-2 lg:gap-3">
                ...
                >
                  <Link
                    href={filteredTrips.length > 0 ? "#reizen" : "/contact"}
                  >
                    {filteredTrips.length > 0
                      ? "Bekijk reizen"
                      : "Reis op maat"}
              ...
              {filteredTrips.length > 0 ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-foreground/70 mb-8 max-w-md mx-auto">
                    We werken aan prachtige reizen in deze regio. Neem contact
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto">
                ...
                >
                  ...
                  {/* Content */}
                  <div className="text-base text-foreground/80 leading-relaxed pl-16 space-y-4">
